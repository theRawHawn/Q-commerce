    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs">
          ...
          <div className="text-[11px] text-slate-500 mt-1">From {stats.totalOrders} jobsite orders today</div>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs">
          <div className="flex items-center justify-between text-slate-500">
            ...
            <span className="text-[10px] font-black text-blue-700 bg-blue-50 px-1.5 py-0.5 rounded">12-Min Promise</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-2xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-black text-slate-900 text-sm">Top Fast-Moving Jobsite SKUs</h3>
        ...
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-2xs space-y-4">
          ...
          <div className="bg-amber-50 border border-amber-200 p-3 rounded-2xl text-xs space-y-1 text-amber-950">
            ...
            <p className="text-[11px] text-amber-900 leading-relaxed">
              Contractors discover missing or broken fittings after reaching jobsites in the morning. Pre-stage Top 20 plumbing valves and MCBs near packing stations for 1-minute pick speeds.
            </p>
          </div>
