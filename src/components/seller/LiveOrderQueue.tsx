                  ...
                  <div className="flex items-start justify-between gap-2 pb-3 border-b border-slate-100">
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500 mt-0.5 flex items-center gap-2">
                        ...
                        <span>•</span>
                        <span className="font-bold text-emerald-700">Target Delivery: 12 Mins</span>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-3xl max-w-sm w-full p-5 shadow-2xl space-y-4 border border-slate-200 font-mono text-xs text-slate-900">
            <div className="text-center pb-3 border-b border-dashed border-slate-300">
              <div className="font-black text-sm">BLINKIT HARDWARE DARK STORE #07</div>
              <div className="text-[10px] text-slate-500">12-MIN EXPEDITED JOBSITE PICK SLIP</div>
