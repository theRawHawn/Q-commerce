export type TradeCategory = 'all' | 'plumbing' | 'electrical' | 'carpentry' | 'fasteners' | 'tools' | 'adhesives' | 'safety';
...
export interface HardwareProduct {
  ...
  sellerDistanceKm?: number; // e.g. 1.2
  ...
  deliveryTimeMins: number; // e.g. 12
  imageUrl?: string;
